...
public class SalonController {
    ...
    @PutMapping("/{salonId}")
    public ResponseEntity<SalonDT0> updateSalon(@PathVariable Long salonId,  @RequestBody SalonDT0 salonDT0) throws Exception {
        UserDTO userDTO = new UserDTO();
        userDTO.setId(1L);
    ...
    @GetMapping("/owner")
    public ResponseEntity<SalonDT0> getSalonsByOwnerId(@PathVariable Long salonId) throws Exception {
        UserDTO userDTO = new UserDTO();
        userDTO.setId(1L);
